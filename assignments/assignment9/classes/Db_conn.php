...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'tyodonnell';//this will be your WCC username
      $dbUsr = 'tyodonnell';//this will be your WCC username
      $dbPass = 'oMKBKkMQFauHQcP';//this will be the password found in the video.
